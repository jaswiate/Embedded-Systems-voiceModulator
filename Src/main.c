...
BSP_DemoTypedef  BSP_examples[] =
  {
	...
	{AudioRec_nightcore, "AUDIO RECORD NIGHTCORE", 0},
	{AudioRec_reverb, "AUDIO RECORD REVERB", 0},
	{AudioRec_distortion, "AUDIO RECORD DISTORTION", 0},
	{AudioRec_vibrato, "AUDIO RECORD VIBRATO", 0},
  };
